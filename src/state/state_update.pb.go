...
type StateUpdateList struct {
	...
	List []*StateUpdate `protobuf:"bytes,1,rep,name=list,proto3" json:"list,omitempty"`
}
...
type StateUpdate struct {
	...
	Data1   int32  `protobuf:"varint,2,opt,name=data1,proto3" json:"data1,omitempty"` // TODO: Decide on data relevant to StateUpdate
}
...
func (x *StateUpdate) GetData1() int32 {
	if x != nil {
		return x.Data1
	}
	return 0
